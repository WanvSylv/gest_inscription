...
<head>
    ...
    <title>Confirmation inscription — HOREB ACADEMY</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
            ...
            <tr>
                <td style="background:linear-gradient(135deg,#0f172a 0%,#1e3a8a 60%,#1a56db 100%);padding:32px 40px;text-align:center;">
                    ...
                    <p style="color:rgba(191,219,254,0.8);font-size:13px;margin:0;font-weight:600;letter-spacing:0.05em;">CONFIRMATION D'INSCRIPTION</p>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding:32px 40px 0;text-align:center;">
                    ...
                    <h1 style="color:#111827;font-size:22px;font-weight:900;margin:0 0 8px 0;">Félicitations {{ $user->name }} !</h1>
                    <p style="color:#16a34a;font-size:14px;font-weight:700;margin:0;">Paiement confirmé — Inscription validée</p>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding:28px 40px;">
                    <p style="color:#374151;font-size:14px;line-height:1.7;margin:0 0 24px 0;">
                        Votre paiement a été traité avec succès. Vous êtes officiellement inscrit(e) à <strong>HOREB ACADEMY</strong> pour l'année académique en cours. Le reçu de paiement est joint à cet email.
                    </p>
                    ...
                    <div style="background:#f0f7ff;border:2px solid #bfdbfe;border-radius:12px;padding:24px;margin-bottom:24px;">
                        ...
                        <table width="100%" cellpadding="8" cellspacing="0">
                            <tr>
                                <td style="color:#6b7280;font-size:13px;width:35%;">Email académique</td>
                            ...
                            <tr>
                                ...
                                <td style="color:#1a56db;font-size:13px;font-weight:700;font-family:'Courier New',monospace;background:#fff;border-radius:6px;padding:6px 10px;">{{ $password }}</td>
                            </tr>
                        </table>
                    </div>

                    <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:8px;padding:12px 16px;margin-bottom:24px;">
                        <p style="color:#92400e;font-size:12px;margin:0;">⚠️ <strong>Important :</strong> Vous serez invité à changer votre mot de passe lors de votre première connexion. Conservez vos identifiants en lieu sûr.</p>
                    </div>
            ...
            <tr>
                <td style="background:#f9fafb;border-top:1px solid #f3f4f6;padding:20px 40px;text-align:center;">
                    ...
                    <p style="color:#d1d5db;font-size:11px;margin:4px 0 0 0;">Le reçu de paiement est joint en pièce jointe PDF.</p>
                </td>
            </tr>
